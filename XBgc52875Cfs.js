document.getElementById("XBgc52875Cfs").innerHTML = `
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div class="container" data-aos="zoom-out" data-aos-delay="100">
        <h2>Decentralized Betting Web3 Social</h2><br>
        <h3>A secure and trusted blockchain-based lottery platform.</h3>
        <br><br><button onclick="window.open('cs', '_blank')"><i class="bi bi-play"></i> Play Now!</button>
      </div>
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h2>What's Unique About Faylotto?</h2>
      ...
      <div class="col-lg-6">
        <div class="team-member d-flex">
          ...
          <div class="member-info flex-grow-1">
            <h4>Lola</h4>
            <span style="color: #00b7ff;">Community Manager</span>
            <p>I'm a professional telegram community manager, with experience in managing communities for a variety of projects including memecoins and utility coins.
<br><br>
     ...
     <div class="col-lg-6">
        <div class="team-member d-flex">
          ...
          <div class="member-info flex-grow-1">
            <h4>Maverick</h4>
            <span style="color: #00b7ff;">Community Manager</span>
            <p>I'm a skilled Community Manager with experience building and engaging online communities.
<br><br>
I create content, manage discussions, handle conflict calmly, and grow communities through events, feedback, and strong communication.
<br><br>
I'm confident using platforms like Discord, Telegram, and X, and I know how to keep members active and connected.</p>
          </div>
        </div>
      </div>
    ...
    <h5 style="font-size: 12px;"><i class="bi bi-envelope-at"></i> Support:<br><a href="mailto:support@faylotto.xyz">support@faylotto.xyz</a></h5>
    <h5 style="font-size: 12px;"><i class="bi bi-envelope-at"></i> Service:<br><a href="mailto:service@faylotto.xyz">service@faylotto.xyz</a></h5>
    <h5 style="font-size: 12px;"><i class="bi bi-envelope-at"></i> Business:<br><a href="mailto:buz@faylotto.xyz">buz@faylotto.xyz</a></h5>
    <h5 style="font-size: 12px;"><i class="bi bi-envelope-at"></i> Info:<br><a href="mailto:info@faylotto.xyz">info@faylotto.xyz</a></h5>
<h5 style="font-size: 12px;"><i class="bi bi-envelope-at"></i> Security:<br><a href="https://faylotto.xyz/thanks">Well-known</a></h5>
  </div>

<div style="text-align: left; margin-left: auto; max-width: 400px;">
  <h4 style="margin-bottom: 10px; font-size: 13px;">Documentation</h4>
  <h5 style="font-size: 12px;"><i class="bi bi-filetype-doc"></i> <a href="https://docs.faylotto.xyz/policy/Disclaimer" target="_blank">Disclaimer</a></h5>
  <h5 style="font-size: 12px;"><i class="bi bi-filetype-doc"></i> <a href="cs" target="_blank">Docs</a></h5>
  <h5 style="font-size: 12px;"><i class="bi bi-filetype-doc"></i> <a href="https://docs.faylotto.xyz/policy/TermsAndConditions" target="_blank">Terms & Conditions</a></h5>
  <h5 style="font-size: 12px;"><i class="bi bi-filetype-doc"></i> <a href="https://docs.faylotto.xyz/policy/PrivacyPolicy" target="_blank">Privacy Policy</a></h5>
  <h5 style="font-size: 12px;"><i class="bi bi-filetype-doc"></i> <a href="https://docs.faylotto.xyz/policy/CookiePolicy" target="_blank">Cookie Policy</a></h5>
<h5 style="font-size: 12px;"><i class="bi bi-filetype-doc"></i> <a href="https://docs.faylotto.xyz/policy/DMCA-Policy" target="_blank">DMCA Policy</a></h5>
<h5 style="font-size: 12px;"><i class="bi bi-filetype-doc"></i> <a href="https://docs.faylotto.xyz/policy/EULA" target="_blank">EULA</a></h5>
  <h5 style="font-size: 12px;"><i class="bi bi-filetype-doc"></i> <a href="https://docs.faylotto.xyz/IP-Policy" target="_blank">IP Policy</a></h5>
<h5 style="font-size: 12px;"><i class="bi bi-filetype-doc"></i> <a href="FaylottoWhitepaper_v02.pdf" target="_blank">Whitepaper</a></h5>
</div>

      </div>
      <div class="social-links d-flex justify-content-center">
        <a href="https://x.com/FaylottoXyz" target="_blank" rel="noopener noreferrer"><i class="bi bi-twitter-x"></i></a>
        <a href="https://t.me/Faylotto" target="_blank" rel="noopener noreferrer"><i class="bi bi-telegram"></i></a>
        <a href="https://facebook.com/Faylotto" target="_blank" rel="noopener noreferrer"><i class="bi bi-facebook"></i></a>
        <a href="https://discord.gg/6uMYTdCZwJ" target="_blank" rel="noopener noreferrer"><i class="bi bi-discord"></i></a>
      </div>
      <div class="container">
        <div class="copyright">
          <span>©</span> <strong class="px-1 sitename">Powered By Faylotto</strong> <span><a href="https://docs.faylotto.xyz/policy/AllRightsReserved" style="color: #007bff; text-decoration: none;" target="_blank">2025 All Rights Reserved.</a> Play responsibly!</span>
        </div>
      </div>
    </div>
  </footer>
