document.getElementById("0xHydfvXx").innerHTML = `
  ...
  <footer id="footer" class="footer dark-background">
    <div class="container">
      <h2 class="sitename">Join Now!</h2>
      <br><button onclick="window.open('cs', '_blank')" style="background: linear-gradient(90deg, #03a9f4, #f441a5); -webkit-background-clip: text; -webkit-text-fill-color: transparent; border: none;"><i class="bi bi-play"></i>Play!</button><br><br>
      <p>Be part of the blockchain lottery revolution. Experience the exciting experience of privacy, transparency, security, and speed in every bet. Try your luck now!</p>
      <div class="social-links d-flex justify-content-center">
        ...
        <a href="mailto:support@lottochain.xyz" target="_blank" rel="noopener noreferrer"><i class="bi bi-envelope"></i></a>
      </div>
      <div class="container">
        <div class="copyright">
